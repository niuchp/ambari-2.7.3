...
Em.I18n.translations = {
  ...
  'app.versionMismatchAlert.body': 'Ambari服务端与Web客户端版本不匹配：<br> ' +
    '<br>Ambari服务端: <strong>{0}</strong>' +
    '<br>Ambari Web客户端: <strong>{1}</strong><br>' +
    '<br>这通常发生在升级Ambari之后，因为浏览器中缓存了Ambari Web客户端代码。' +
    '<br>执行硬浏览器缓存刷新，通常是 \'Ctrl+Shift+R\' (中OS X 上是\'Cmd+Shift+R\')，以查看此消息是否消失。' +
    '<br>如仍能持续看到此消息，请完全清除浏览器缓存并再次点击此URL。' +
    '<br>你必须解决此错误才能继续。',
  'app.signout':'退出',
  'app.settings':'设置',
  ...
  'app.aboutAmbari.licensed': '根据Apache许可证2.0版获得许可',
  ...
  'common.timeout.warning.popup.body.before': '你将自动注销，于 ',
  'common.timeout.warning.popup.body.after': ' 秒，由于无活动',
  ...
  'requestInfo.stopAllServices':'停止全部服务',
  'requestInfo.startAllServices':'启动全部服务',
  ...
  'hostPopup.bgop.abortRequest.confirmation.body': '确定要中止\'{0}\'的操作吗?',
  ...
  'hostPopup.warning.alertsTimeOut': '维护模式已变为{0}。告警可能需要几分钟{1}。',
  'hostPopup.reccomendation.beforeDecommission': '{0}退役时需要维护模式。',
  'hostPopup.setRackId.success': '将机架ID更新为\"{0}\"。可能需要一些时间才能刷新',
  'hostPopup.setRackId.error': '更新机架ID失败。',
  'hostPopup.setRackId.invalid': '应该以正斜杠开头，可能包含字母数字字符、点、破折号和正斜杠。应少于255字符',
  'hostPopup.RackId': '机架',
  'hostPopup.recommendation.beforeDecommission': '{0}退役时需要维护模式。',
  'hostPopup.default.userName': '无',

  'question.sure':'你确定?',
  'question.sure.restart':'你确定要重启{0}?',
  'question.sure.start':'你确定要启动{0}?',
  'question.sure.stop':'你却动要停止{0}?',
  'question.sure.move':'你确定要移除{0}?',
  'question.sure.refresh':'你确定要重启所有客户端在{0}?',
  'question.sure.maintenance':'你确定要对{0}进入维护模式?',
  'question.sure.upgrade':'你确定要升级{0}?',
  'question.sure.decommission':'你确定要退役{0}?',
  'question.sure.recommission':'你确定要重新使用{0}?',
  'question.sure.startAll':'你确定要启动全部组件?',
  'question.sure.stopAll':'你确定要停止全部组件?',
  'question.sure.restartAll':'你确定要重启全部组件?',
  'question.sure.regenerateKeytab.service': '你确定要为{0}服务重新生成keytab文件？',
  'question.sure.regenerateKeytab.host': '你确定要为{0}主机重新生成keytab文件？',

  'popup.highlight':'点击突出显示',
  'popup.confirmation.commonHeader':'确认',
  'popup.confirmation.refreshYarnQueues.body':'在更改大小调整配置后，强烈建议<strong>刷新Yarn队列</strong>，你想继续吗？',
  'popup.warning.refreshYarnQueues.body': '<div class="alert alert-warning"><strong>警告： </strong>队列配置更改可能会影响Hive LLAP。可能需要Hive LLAP重新配置或重启。</div>',
  'popup.confirmation.refreshYarnQueues.buttonText':'Refresh Yarn Queues',
  'popup.confirmation.hsiRestart.body':'在更改Hive LLAP大小调整配置后，强烈建议<strong>重启HiveServer2 Interactive</strong>，你要继续吗？',
  ...
  'popup.clusterCheck.Upgrade.bypassed-failures.alert': '由于stack.upgrade.bypass.prechecks设置为true。因此可以绕过错误。强烈建议查看这些故障。',
  ...
  'popup.clusterCheck.Upgrade.configsMerge.alert': '升级过程中，将会应用一下配置更改。',
  ...
  'popup.clusterCheck.Upgrade.configsMerge.deprecated': '属性已启用',
  'popup.clusterCheck.Upgrade.configsMerge.willBeRemoved': '将被移除',
  'popup.clusterCheck.Upgrade.configsRecommend.alert': '我们检车道需要更新以下属性' +
  '但是由于它们已经被定制，所以不能自动执行。请手动查看这些属性，' +
  '并在必要时手动更新。',
  ...
  'popup.clusterCheck.Security.alert': '必须满足一下要求才能启用安全性。',
  ...
  'installer.step3.hostWarningsPopup.notice.beginning': '手动解决问题后，单机<b>重新检查</b>.',
  ...
  'installer.step4.fsCheck.popup.body':'你没有选择文件系统，至少需要选择一个。我们将自动添加{0}。可以吗?',
  'installer.step4.multipleDFS.popup.header':'选择多个文件系统',
  'installer.step4.multipleDFS.popup.body':'你已选多个文件系统，将自动选择{0}. 可以吗?',
  'installer.step4.serviceCheck.popup.header':'需要{0}',
  'installer.step4.serviceCheck.popup.body':'你没有选择{0},但是你选择的其他服务需要它{1}.我们会自动添加{0}。可以吗?',
  'installer.step4.serviceCheck.popup.body.multiOptions':'您没有选择{0}，但您选择的其他服务需要它。从以下列表中选择兼容服务：{1}',
  ...
  'installer.step7.databasesTab.body':'请为这些服务选择并配置相应的数据库',
  ...
  'alerts.definition.details.infoSection': 'Alert信息',
  ...
  'alerts.notifications.regenerateKeytab.service.error' : '无法重新生成{0}服务的Keytabs',
  'alerts.notifications.regenerateKeytab.host.error' : '无法重新生成{0}主机的Keytabs',


  'wizard.progressPage.notice.completed':'请继续下一步。',
  'wizard.progressPage.notice.failed':'您可以单击“重试”按钮以重试失败的任务。',
  ...
  'admin.manageJournalNode.step4.save.configuration.note' : '此配置由Manage JournalNode Wizard创建',

  'admin.manageJournalNode.wizard.progressPage.notice.inProgress': '正在部署JournalNodes请稍候',
  'admin.manageJournalNode.wizard.step4.notice.inProgress': '正在部署JournalNodes请稍候',
  'admin.manageJournalNode.wizard.step6.notice.inProgress': '在JournalNodes启动时请稍候',
  'admin.manageJournalNode.wizard.step7.notice.inProgress': '服务开始时请稍等',
  'admin.manageJournalNode.wizard.step7.notice.completed':'已完成对JournalNodes的更新',

  'admin.manageJournalNode.wizard.step3.error.multipleNameSpaces.nameNodes': '某些NameNode正在被停止。请确保NameNodes正在运行以成功创建检查点。',
  ...
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.proceed': '一旦Ambari检测到NameNode处于安全模式且检查点已成功创建，您就可以继续操作。',
  'admin.manageJournalNode.wizard.step3.body.singleNameSpace.recentCheckPoint': '如果在运行<b>“步骤3：保存命名空间”</b>命令之前启用了<b>下一步</b>按钮，则表示已经有最近的检查点，您可以继续运行<b>“步骤3：保存命名空间”</b>命令。',
  'admin.manageJournalNode.wizard.step3.body.multipleNameSpaces.recentCheckPoint': '如果在运行<b>“步骤3：保存命名空间”</b>命令之前启用了<b>下一步</b>按钮，则表示已经有最近的检查点，您可以在不运行<b>的情况下继续“第3步：保存命名空间”</b>命令。',
  ...
  '<li>创建Journal目录的压缩包:{1}.</li>' +
  '<li>将tarball复制到新的JournalNodes上，然后按照步骤2中的相应位置解压缩。</li>' +
  '</ol>',
  ...
  'admin.highAvailability.wizard.step9.notice.completed':'NameNode HA启用成功',
  ...
  'admin.highAvailability.wizard.step8.body':
    ...
    '<div class="alert alert-warning"><strong>Important!</strong> 请务必登录Additional NameNode主机。<br>这是与上面的步骤1和2不同的主机。</div>' +
    '</li>' +
    '<li>通过运行以下命令初始化Additional NameNode的元数据：' +
    '<div class="code-snippet">sudo su {0} -l -c \'hdfs namenode -bootstrapStandby\'</div></li>' +
    '</ol>',
  'admin.highAvailability.wizard.step8.proceed': '完成上述步骤后请继续。',
  'admin.highAvailability.wizard.step6.body':
    ...
    '<li>Ambari检测到JournalNodes已成功初始化后，您就可以继续。</li>' +
    '</ol>',
  'admin.highAvailability.wizard.step4.body':
    '<ol>' +
    '<li>登录到NameNode主机 <b>{1}</b>.</li>' +
    '<li>将NameNode置于安全模式下 (只读模式):' +
    '<div class="code-snippet">sudo su {0} -l -c \'hdfs dfsadmin -safemode enter\'</div></li>' +
    '<li>进入安全模式后，创建一个检查点：' +
    '<div class="code-snippet">sudo su {0} -l -c \'hdfs dfsadmin -saveNamespace\'</div></li>' +
    '<li>Ambari检测到NameNode处于安全模式并且检查点已成功创建后,您将可以继续.</li>'+
  ...
  '如果您选择退出，则必须按照手动说明完成或恢复启用Ranger Admin HA，如Ambari用户指南中所述。您确定要退出向导吗？',

  'admin.nameNodeFederation.button.enable':'添加新的HDFS命名空间',
  'admin.nameNodeFederation.wizard.required.zookeepers': '所有的Zookeeper Server都应该启动',
  'admin.nameNodeFederation.wizard.required.journalnodes': '所有的JournalNodes都应该启动',
  'admin.nameNodeFederation.wizard.header': '添加新的HDFS命名空间',
  'admin.nameNodeFederation.closePopup': '你确定要退出吗？',
  'admin.nameNodeFederation.closePopup2': '添加新的HDFS命名空间向导正在进行中。必须允许向导完成Ambari才能处于可用状态。如果选择退出，则必须按照手动说明完成或恢复添加新HDFS命名空间，如Ambari用户指南中所述。您确定要退出向导吗？',
  'admin.nameNodeFederation.wizard.step1.header': '入门',
  'admin.nameNodeFederation.wizard.step1.body':'该向导将引导您完成设置一对新的高可用NameNode节点过程，该对节点将用于创建新的HDFS命名空间，允许您使用Ambari管理多个HDFS命名空间并利用HDFS Federation。',
  'admin.nameNodeFederation.wizard.step1.alert':'您应该计划集群维护窗口并在添加新的HDFS命名空间时为集群停机做好准备，因为此向导将重新启动所有服务。',
  'admin.nameNodeFederation.wizard.step1.nameserviceid':'新的Nameservice ID',
  'admin.nameNodeFederation.wizard.step1.nameserviceid.existing':'存在的Nameservice ID',
  ...
  'admin.nameNodeFederation.wizard.step3.confirm.config.body': '<div class="alert alert-info">' +
    '<p><b>查看配置更改。</b></p>' +
    '下面列出了向导将启用NameNode Federation的配置更改。此信息仅供<b>查看</b>，除<b> dfs.journalnode.edits.dir </b>属性外，不可编辑' +
    '</div>',
  'admin.nameNodeFederation.wizard.step4.header': '配置组件',
  'admin.nameNodeFederation.wizard,step4.save.configuration.note':'此配置由Enable NameNode Federation向导创建',
  'admin.nameNodeFederation.wizard.step4.notice.inProgress':'请等待部署新的HDFS命名空间。',
  'admin.nameNodeFederation.wizard.step4.notice.completed':'添加新的HDFS命名空间向导已成功完成。',
  'admin.nameNodeFederation.wizard.step4.task0.title': '停止所需服务',
  'admin.nameNodeFederation.wizard.step4.task1.title': '重新配置服务',
  'admin.nameNodeFederation.wizard.step4.task2.title': '安装Additional NameNodes',
  'admin.nameNodeFederation.wizard.step4.task3.title': '安装Additional ZKFCs',
  ...
  'admin.security.title':'尚未启用Kerberos security',
  'admin.security.enabled': 'Kerberos安全性已启用',
  'admin.security.disabled': 'Kerberos安全性已禁用',
  ...
  'admin.misc.nothingToShow': '没有用户账户显示',

  'admin.serviceAutoStart.title': "服务自动启动",
  'admin.serviceAutoStart.header.text': "Ambari服务可以配置为在系统引导时自动启动。 每个服务都可以配置为启动所有组件，主服务器和工作程序，或者有选择地启动。",
  ...
  'admin.stackVersions.upgrade.patch.revert.confirmation':'您确定要还原以下服务：',
  'admin.stackVersions.editRepositories.info': '为您正在配置的操作系统提供基本URL。',
  'admin.stackVersions.editRepositories.validation.warning': '某些存储库未通过验证。如果您确定网址是正确的，请更改基本网址或跳过验证',
  'admin.stackVersions.version.install.confirm': '您即将在所有主机上安装<strong>{0}</strong>版本的软件包。',
  'admin.stackVersions.version.install.patch.confirm': '您即将在包含以下服务的主机上安装<strong>{0}</strong>版本的软件包：',
  ...
  'admin.stackVersions.version.upgrade.running.nonWizard': "升级：正在处理中| 由{0}发起",
  ...
  'admin.stackVersions.version.errors.outOfSync.desc': '其中一个主机组件未报告Ambari预期的版本。' +
  ...
  'admin.stackVersions.hosts.popup.primary': "到主机",
  ...
  'admin.stackUpgrade.finalize.message.revertible': "<b>{0}</b>升级至<b>{1}</b>已准备好完成。" +
  " 完成后，如果不再需要，可以从“堆栈和版本”页面恢复修补程序。",
  'admin.stackUpgrade.finalize.message.autoStart': "如果禁用升级，请记得重新启用自动启动。",
  ...
  'admin.stackUpgrade.dialog.skipped.failures':'有自动跳过失败的步骤。 请在继续升级之前解决每个故障。',
  'services.service.start':'开始',
  'services.service.stop':'停止',
  'services.service.allComponents':'全部组件',
  ...
  'services.service.summary.PhoenixServersLIVE':'Phoenix Query服务器Live',
  ...
  'services.service.summary.jobTrackerWebUI':'JobTracker界面',
  ...
  'services.service.summary.totalJobs':'任务总数',
  ...
  'services.service.summary.masterStarted':'Master已启动',
  'services.service.summary.masterActivated':'Master已激活',
  ...
  'services.service.actions.hsi.alertPopup.header':'无法启用Interactive Query',
  'services.service.actions.hsi.alertPopup.body':'您无法立即启用Interactive Query，因为Interactive Query正在被禁用。 这可能需要几分钟的时间。 稍后再试。',
  ...
  'services.service.confirmDelete.popup.body': '你必须在确认框中输入"{1}来确认删除<b>{0}</b>' +
  ' <b>此操作不可逆,所有配置历史记录将丢失.</b>',
  ...
  'services.service.config.restartService.needToRestartEnd':'应该重启',
  ...
  'services.service.config.database.msg.jdbcSetup.detailed': '要将{0}和{6}一起使用，必须从<a rel="noopener noreferrer" href="{3}" target="_blank">' +
    '{0}下载{4}</a>. 下载后运行: <br/>' +
  ...
  'services.add.warning': '正在添加服务向导中，你确定想要退出吗？',
  'services.add.warningStep6': '关闭此对话框将继续在后台安装所选服务，但需要手动启动已安装的服务。 你确定你要退出吗？',
  ...
  'services.service.restartAllRequired':'重启所有必须',
  ...
  'services.service.stopCertain.warningMsg.turnOnMM': '这将在组件停止时生成警报。 要禁止警报，请在停止前打开{0}的维护模式。',
  'services.service.stop.warningMsg.dependent.services': '停止{0}可能会影响其相关服务的功能：{1}。',
  ...
  'services.service.restartCertain.warningMsg.turnOnMM': '这将在重新启动组件时触发警报。 要禁止警报，请在运行全部重启之前打开{0}的维护模式',
  'services.service.componentsInNameSpace': '{0}命名空间中的组件',
  'services.service.stop.HDFS.warningMsg.checkPointNA': '无法确定最后一个HDFS检查点的年龄。 请确保您有最近的检查站。 否则，NameNode可能需要很长时间才能启动。',
  ...
  'services.service.stop.HDFS.warningMsg.checkPointTooOld.makeSure': '在继续之前确保您已经检查了一个检查点。 否则，NameNode可能需要很长时间才能启动。',
  'services.service.stop.HDFS.warningMsg.nameSpaces.checkPointTooOld': '对于以下命名空间，最后一个HDFS检查点的时间早于{0}小时：',
  ...
  'services.reassign.step4.task0.title':'停止必须的服务',
  ...
  'services.reassign.step4.save.configuration.note':'此配置由Move {0}向导创建',
  ...
  'services.mapreduce2.history.running': 'History server正在运行',
  ...
  'alerts.actions.manage_alert_groups_popup.addDefinitionDisabled':'没有可用的警报定义',
  ...
  'hosts.filters.filteredHostsInfo': '{1}个主机中显示{0}个',
  ...
  'hosts.bulkOperation.confirmation.add.component.nothingToDo.body': '所有选定的主机已安装{0}。',
  'hosts.bulkOperation.confirmation.cannot.add1': '将跳过以下主机（展开原因）：',
  'hosts.bulkOperation.confirmation.cannot.add2': '无法将{0}添加到以下主机（展开原因）：',
  'hosts.bulkOperation.deleteHosts.nonDeletableComponents': '不支持删除以下组件：{0}',
  'hosts.bulkOperation.deleteHosts.nonAddableMasterComponents': '主机包含以下主要组件：{0}',
  'hosts.bulkOperation.deleteHosts.lastMasterComponents': '集群不包含以下主要组件的任何其他实例：{0}',
  ...
  'hosts.bulkOperation.deleteHosts.cannot.delete2':'Selected hosts cannot be deleted (展开原因)',
  'hosts.bulkOperation.deleteHosts.confirmation.header':'确认批量删除主机',
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg1': '<b>请注意:</b>移除后, Ambari将忽略来自这些主机的未来通信。作为删除过程的一部分，不会删除包，因此请不要尝试在从Ambari中删除主机后手动启动主机上的服务。 如果要将主机重新添加到集群，请在尝试添加主机之前完全清除主机。',
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg2': '为了确保它们完全从Ambari数据库中删除，',
  'hosts.bulkOperation.deleteHosts.confirmation.body.msg3': '请确保在继续之前，Ambari代理进程在这些主机上完全停止。',
  ...
  'hosts.selectHostsDialog.message': '选择应属于此{0}配置组的主机。 属于该组的所有主机都将具有相同的配置集。',
  'hosts.selectHostsDialog.filter.placeHolder': '过滤...',
  'hosts.selectHostsDialog.selectedHostsLink': '已选择{1}个主机中的{0}个',
  'hosts.selectHostsDialog.message.warning': '至少需要选择一个主机。',

  'hosts.host.serviceNotAvailable': '此主机上没有此服务',
  ...
  'hosts.cant.do.popup.masterList.body':'无法删除此主机，因为它具有以下主要组件：',
  'hosts.cant.do.popup.masterList.body.end':'要删除此主机，必须先移动上面列出的所有主组件。',
  ...
  'hosts.cant.do.popup.runningList.body.end':'要删除此主机，必须先停止上面列出的所有正在运行的组件。' +
    '如果此主机具有{0}，则应首先将其停用以防止数据丢失。',
  'hosts.cant.do.popup.lastMasterList.body':'由于以下主组件没有任何其他实例，因此无法删除此主机：',
  'hosts.cant.do.popup.lastMasterList.body.end':'要删除此主机，必须先将上面列出的所有组件添加到其他主机',
  ...
  'dashboard.button.reset': '将所有控件重置为默认值',
  'dashboard.widgets.actions.title': '指标操作',
  'dashboard.widgets.create': '创建控件',
  'dashboard.widgets.actions.browse': '浏览控件',
  'dashboard.widgets.layout.import': '导入布局',
  'dashboard.widgets.layout.save': '保存布局',
  'dashboard.widgets.addButton.tooltip': '添加控件',
  'dashboard.widgets.browser.header': '控件浏览',
  'dashboard.widgets.browser.menu.shared': '分享',
  'dashboard.widgets.browser.menu.mine': '我的',
  'dashboard.widgets.browser.noWidgets': '没有控件可显示',
  'dashboard.widgets.browser.footer.checkbox': '仅显示我的控件',
  ...
  'dashboard.widgets.browser.action.share.confirmation': '您即将使其成为共享控件. 所有集群操作员都可以修改或删除此控件. 您确定要共享此控件?',
  'dashboard.widgets.browser.shareIcon.tooltip': '共享',
  'dashboard.widgets.browser.action.delete.shared.bodyMsg': '您即将永久删除 <b>{0}</b>控件. ' +
    '此控件是一个共享的控件,此操作将从共享的控件库中删除小部件,并删除 ' +
    '所有用户的控件.<br /> <br /> <b>您确定要永久删除此共享控件?</b>',
  'dashboard.widgets.browser.action.delete.mine.bodyMsg': '您即将永久删除 <b>{0}</b> 控件. ' +
  ...
  'dashboard.widgets.nothing': '无控件添加',
  ...
  'dashboard.widgets.error.invalid': '无效！输入介于{0}-{1}之间的数字',
  ...
  'dashboard': {
    'widgets': {
      ...
      'hintInfo': {
        ...
        'hint1': '编辑阈值的百分比来更改当前窗口控件的颜色. <br />假设所有控件UP为100, 全部DOWN为0. <br /> 输入0到{0}之间的两个数字',
        'hint2': '编辑阈值以更改当前控件的颜色.<br /><br />输入两个大于0的数字.',
        'hint3': '编辑阈值以更改当前控件的颜色.<br />单位是毫秒. <br />输入两个大于0的数字. ',
        'hint4': '编辑表示向下调整的{0} 数的阈值,以更改窗口组件的颜色. <br />如果关闭的{0} 数量大于阈值,该控件将以红色显示警告. <br />选择0到{1}之间的数字. '
      }
    }
  },
  ...
  'dashboard.services.hdfs.summary':'{1}个节点中有{0}个存活，使用了{2}％的容量',
  ...
  'dashboard.services.hdfs.capacity.dfsUsed':'磁盘用量 (DFS使用)',
  'dashboard.services.hdfs.capacity.nonDfsUsed':'磁盘用量 (非DFS使用)',
  ...
  'dashboard.services.hdfs.blockErrors.corrupt': '损坏副本',
  'dashboard.services.hdfs.blockErrors.replicated': '副本不足',
  'dashboard.services.hdfs.blockErrors.missing': '缺失',
  'dashboard.services.hdfs.datanode.status.tooltip.live': '这是从NameNode报告的实时DataNode数。' +
    '即使DataNode进程已启动，如果DataNode未按预期与NameNode通信，NameNode可能会将状态视为已死。' +
    '这可能是由于过多的垃圾收集导致的网络问题或挂起的DataNode进程等情况。',
  'dashboard.services.hdfs.datanode.status.tooltip.dead': '这是从NameNode报告的死亡的DataNode数。' +
  '即使DataNode进程已启动，如果DataNode未按预期与NameNode通信，NameNode可能会将状态视为已死。' +
  '这可能是由于过多的垃圾收集导致的网络问题或挂起的DataNode进程等情况。',
  ...
  'dashboard.services.yarn.nodeManagers.status.tooltip.lost': '这是从ResourceManager报告的丢失的NodeManager数。' +
    '即使NodeManager进程已启动，如果NodeManager未按预期与ResourceManager通信，ResourceManager也可能会看到状态丢失。' +
    '这可能是由于网络问题或由于过多的垃圾收集导致的挂起的NodeManager进程等情况。',
  'dashboard.services.yarn.nodeManagers.status.tooltip.unhealthy': '这是从ResourceManager报告的不健康的NodeManagers数。',
  'dashboard.services.yarn.nodeManagers.status.tooltip.rebooted': '这是从ResourceManager报告的处于重新启动状态的NodeManager的数量。',
  'dashboard.services.yarn.nodeManagers.status.tooltip.decommissioned': '这是从ResourceManager报告的退役NodeManagers的数量。',
  ...
  'dashboard.services.flume.summary.title':'Flume安装在{0}主机{1}上（{2}代理{3}）',
  ...
  'dashboard.services.hbase.noMasterServer':'无Active Master',
  ...
  'dashboard.services.hbase.masterServerUptime':'Master Server正常运行时间',
  ...
  'dashboard.services.hbase.regionServersSummary':'{0}存活/{1}总计',
  'dashboard.services.hbase.phoenixServers':'Phoenix查询服务端',
  'dashboard.services.hbase.phoenixServersSummary':'{0}存活/{1}总计',
  ...
  'dashboard.services.hbase.masterStarted':'Master启动',
  'dashboard.services.hbase.masterActivated':'Master激活',
  ...
  'dashboard.configHistory.info-bar.view.button.disabled': '您目前正在查看此版本。',
  ...
  'dashboard.configHistory.info-bar.compare.tooltip': '比较此版本与当前版本',
  ...
  'widget.type.gauge.description': '显示可以百分比表示的指标的视图。',
  'widget.type.number.description': '显示可以使用可选单位字段表示为单个数字的指标的视图。',
  'widget.type.graph.description': '显示可在一个时间范围内以折线图或面积图表示的指标的视图。',
  'widget.type.template.description': '用于显示度量标准值以及模板化文本的视图。',
  'widget.create.wizard.header': '创建控件',
  'widget.create.wizard.step1.header': '选择类型',
  'widget.create.wizard.step1.body.text': '您想要创建哪种类型的控件？',
  ...
  'widget.create.wizard.step2.body.template':'使用任意数量的表达式和任何字符串定义模板。 可以通过用双花括号括起其名称来从模板引用表达式。',
  'widget.create.wizard.step2.body.warning':'注意：有效的运算符是+, -, *, /',
  'widget.create.wizard.step2.body.invalid.expression':'表达不完整或无效！',
  'widget.create.wizard.step2.body.invalid.expression2':'表达式无效!',
  'widget.create.wizard.step2.body.invalid.msg2':'此字段中仅允许使用数字或运算符。',
  'widget.create.wizard.step2.body.template.invalid.msg':'存在无效的表达式名称。 应该使用带有双花括号的名称“Expression＃”。',
  'widget.create.wizard.step2.addExpression': '添加表达式',
  'widget.create.wizard.step2.addDataset': '添加数据集',
  'widget.create.wizard.step2.body.gauge.overflow.warning':'溢出！Gauge只能显示0到1之间的数字。',
  ...
  'widget.create.wizard.step3.name.invalid.msg': '控件名称太长。 请输入小于129个字符的控件名称。',
  'widget.create.wizard.step3.name.invalidCharacter.msg': '控件名称无效。 只允许使用字母数字，下划线，连字符，百分比和空格。',
  'widget.create.wizard.step3.description.invalid.msg': '描述太长了。 请输入少于2049个字符的说明。',
  'widget.create.wizard.step3.description.invalidCharacter.msg': '输入无效。 只允许使用字母数字，下划线，连字符，百分比和空格。',

  'widget.edit.wizard.header': '编辑控件',

  'widget.clone.body': '你确定要克隆当前控件<b>{0}</b>?',
  'widget.edit.body': '这是一个共享控件，编辑将为所有用户更改此控件。 你想要克隆控件吗？',
  'widget.edit.button.primary': '编辑共享',
  'widget.edit.button.secondary': '克隆并编辑',

  'dashboard.widgets.wizard.step2.dataSeries': '数据序列{0}',
  'dashboard.widgets.wizard.step2.addMetrics': '在此处添加指标和操作...',
  ...
  'dashboard.widgets.wizard.step2.aggregateFunction.notFound': '未发现聚合函数',
  'dashboard.widgets.wizard.step2.aggregateTooltip': '此数学函数将应用于计算所有主机组件中所选指标的单个值',
  'dashboard.widgets.wizard.step2.threshold.ok.tooltip': '这是窗口控件颜色从绿色（OK）变为橙色（警告）的阈值',
  'dashboard.widgets.wizard.step2.threshold.warning.tooltip': '这是控件颜色从橙色（警告）变为红色（严重）的阈值',
  ...
  'dashboard.widgets.wizard.step2.nameSpaceDropDownItem': '{0} (活跃)',
  ...
  'config.group.selection.dialog.subtitle': '选择或创建一个{0}配置组，其中将覆盖配置值。',
  'config.group.selection.dialog.option.select': '选择现有的{0}配置组',
  'config.group.selection.dialog.option.select.msg': '将为属于所选组的主机更改重写属性。',
  ...
  'config.warnMessage.outOfBoundaries.less': '建议不要使用小于{0}的值',
